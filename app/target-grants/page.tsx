  ...
  return (
    <>
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-muted">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              SmartGrant helps Singapore SMEs access a wide range of government grants. Learn about the key grants and see if your business qualifies.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="container mx-auto px-4">
          <SectionHeading 
            ...
            subtitle="Grant eligibility can be complex, but SmartGrant simplifies the process by automatically matching your business with grants you qualify for."
          />
          ...
          <div className="max-w-3xl mx-auto bg-card p-6 md:p-8 rounded-lg shadow-sm">
            ...
            <div className="mt-8 p-4 bg-primary/10 rounded-md border border-primary/20">
              <p className="font-medium">
                SmartGrant's AI analyzes over 100 eligibility factors to match your business with suitable grants, saving you hours of research and reducing the risk of application rejection.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <SectionHeading 
            title="SmartGrant vs. Alternatives" 
            subtitle="See how SmartGrant compares to traditional grant consultants and government portals."
          />
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto mb-8">
            Use SmartGrant to instantly see which grants your business is eligible for and get started on your applications.
          </p>
          <Button 
            size="lg" 
            variant="secondary" 
