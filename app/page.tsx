  ...
  return (
    <>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          <SectionHeading 
            title="Why Choose SmartGrant?" 
            subtitle="Our AI platform automates every step of the grant application process, saving you time and money while increasing your chances of success."
          />
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <SectionHeading 
            ...
            subtitle="Find answers to the most common questions about SmartGrant and our services."
          />
