    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <SectionHeading 
                title="Our Story" 
                subtitle="How SmartGrant came to be and our vision for the future."
                align="left"
                className="mb-8"
              />
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="container mx-auto px-4">
          <SectionHeading 
            ...
            subtitle="SmartGrant PTE. LTD. is a registered company in Singapore."
          />
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <SectionHeading 
            title="Meet Our Team" 
            subtitle="The people behind SmartGrant."
          />
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="container mx-auto px-4">
          <SectionHeading 
            ...
            subtitle="The powerful technology stack that powers SmartGrant."
          />
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <SectionHeading 
            title="Our Values" 
            subtitle="The principles that guide everything we do at SmartGrant."
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground">
                We continually push the boundaries of what's possible with AI to create better, more efficient solutions for our customers.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                We believe in being open and honest about how our technology works, our pricing, and what customers can expect from our service.
              </p>
            </motion.div>
          </div>
        </div>
