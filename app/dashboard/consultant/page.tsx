        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold">SmartGrant Consultant Dashboard</h1>
            </div>
            <Button
            ...
            <Card className="md:col-span-2 lg:col-span-3">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>Welcome, {profile?.full_name || 'Grant Consultant'}!</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Welcome to your SmartGrant consultant dashboard. Manage your clients and their grant applications efficiently.
                </p>
                {profile?.company && (
